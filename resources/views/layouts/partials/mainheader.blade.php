...
<header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
        ...
        <span class="logo-mini"><b>若邻</b>汇</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>若邻汇</b>后台管理 </span>
    </a>
                ...
                @else
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="{{config('app.url')}}/img/avatar.png" class="user-image" alt="User Image"/>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    {{ Auth::user()->name }}
                                    <small>{{ trans('adminlte_lang::message.login') }}于：{{ date('Y-m-d H:i') }}</small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            <li class="user-body">
