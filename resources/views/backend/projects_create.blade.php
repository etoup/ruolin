    ...
    <div class="row">
        <div class="col-lg-12 col-xs-12">
            <div class="form-group">
                ...
                {!! Form::text('describe', '', ['class' => 'form-control', 'placeholder' => '填写品牌描述']) !!}
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12 col-xs-12">
            <div class="form-group">
                ...
                {!! Form::text('characteristic', '', ['class' => 'form-control', 'placeholder' => '填写项目特色']) !!}
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12 col-xs-12">
            <div class="form-group">
                ...
                {!! Form::text('policy', '', ['class' => 'form-control', 'placeholder' => '填写招商政策']) !!}
            </div>
        </div>
    </div>
