{!! Form::open(['route' => 'backend.regions.store', 'role' => 'form']) !!}
	...
	<div class="row">
		<div class="col-lg-12 col-xs-12">
			<div class="form-group">
				...
				{!! Form::text('name', $info->name, ['class' => 'form-control', 'placeholder' => '填写地区名称']) !!}
			</div>
		</div>
		<div class="col-lg-12 col-xs-12">
			<div class="form-group">
...
<div class="modal-footer">
	...
	<button type="submit" class="btn btn-primary btn-flat">编辑地区</button>
</div>
{!! Form::close() !!}
